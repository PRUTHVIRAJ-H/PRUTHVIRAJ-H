...
- 🛠️ **Current Focus:** Expanding into **AI(GENERATIVE,AGENTIC) and DevOps** to bridge the gap between code and infrastructure.
- 💡 **Learning motive:** If you can't explain the logic, you don't know the tech.

---

### 🛠 Tech Stack & Tools
- **Web:** MongoDB, Express.js, React, Node.js, FastAPI, Flask, Sqlite.
- **Systems/Hardware:** Verilog HDL, Assembly, Computer Architecture(RISC AND CISC) Preferably ARM.
- **Interests:** Ai,DevOps,Coud Computing.
